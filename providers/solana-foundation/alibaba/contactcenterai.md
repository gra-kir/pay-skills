...
openapi:
  url: https://production-pay-alibaba-contactcenterai-<RAM>.us-central1.run.app/openapi.json
name: contactcenterai
sandbox_service_url: https://sandbox-pay-alibaba-contactcenterai-<RAM>.us-central1.run.app
service_url: https://production-pay-alibaba-contactcenterai-<RAM>.us-central1.run.app
