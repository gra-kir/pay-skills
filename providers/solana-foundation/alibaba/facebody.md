...
openapi:
  url: https://production-pay-alibaba-facebody-<RAM>.us-central1.run.app/openapi.json
name: facebody
sandbox_service_url: https://sandbox-pay-alibaba-facebody-<RAM>.us-central1.run.app
service_url: https://production-pay-alibaba-facebody-<RAM>.us-central1.run.app
