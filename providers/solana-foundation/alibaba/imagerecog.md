...
openapi:
  url: https://production-pay-alibaba-imagerecog-<RAM>.us-central1.run.app/openapi.json
name: imagerecog
sandbox_service_url: https://sandbox-pay-alibaba-imagerecog-<RAM>.us-central1.run.app
service_url: https://production-pay-alibaba-imagerecog-<RAM>.us-central1.run.app
